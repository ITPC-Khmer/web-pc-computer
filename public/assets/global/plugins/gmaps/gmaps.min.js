!function (e, t) {
    ...
    var t = function (e, t) {
        ...
        var o, n = Array.prototype.slice.call(arguments, 2), r = [], s = e.length;
        ...
        }); else for (o = 0; s > o; o++)callback_params = n, callback_params.splice(0, 0, e[o]), r.push(t.apply(this, callback_params));
        return r
    }, n = function (e) {
        var t, o = [];
        ...
        var e = document, o = function (n) {
            ...
            var r, s = this,
                ...
                c = n.el || n.div, h = n.markerClusterer, u = google.maps.MapTypeId[n.mapType.toUpperCase()],
                d = new google.maps.LatLng(n.lat, n.lng), f = n.zoomControl || !0,
                m = n.zoomControlOpt || {style: "DEFAULT", position: "TOP_LEFT"}, y = m.style || "DEFAULT",
                v = m.position || "TOP_LEFT", k = n.panControl || !0, w = n.mapTypeControl || !0,
                L = n.scaleControl || !0, b = n.streetViewControl || !0, _ = _ || !0, M = {},
            ...
            var P = function (e, t) {
                ...
                if (i("gmaps_context_menu")) {
                    ...
                    p.innerHTML = o;
                    var r, g = p.getElementsByTagName("a"), c = g.length;
                    for (r = 0; c > r; r++) {
                        var h = g[r], u = function (o) {
                    ...
                    var d = a.apply(this, [s.el]), f = d[0] + t.pixel.x - 15, m = d[1] + t.pixel.y - 15;
            ...
            this.buildContextMenu = function (e, t) {
                ...
                for (o in t.options)if (t.options.hasOwnProperty(o)) {
                    var r = t.options[o];
                    window.context_menu[s.el.id][t.control][r.name] = {title: r.title, action: r.action}
                }
    ...
    l.prototype.createControl = function (e) {
        ...
        if (t)for (o = 0; o < this.map.controls.length; o++) {
        ...
        var o = this, n = e.details, r = e.fences, s = e.outside,
            i = {position: new google.maps.LatLng(e.lat, e.lng), map: null}, a = t(i, e);
        ...
        return t.setMap(this.map), null != e.auto_show && (o = e.auto_show), t.onAdd = function () {
            ...
            var n = this.getPanes(), r = n[e.layer], s = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            r.appendChild(o);
            ...
            var n = this.getProjection(), r = n.fromLatLngToDivPixel(new google.maps.LatLng(e.lat, e.lng));
            e.horizontalOffset = e.horizontalOffset || 0, e.verticalOffset = e.verticalOffset || 0;
            var s = t.el, i = s.children[0], a = i.clientHeight, l = i.clientWidth;
        ...
        var r = !1;
        e.hasOwnProperty("useGeoJSON") && (r = e.useGeoJSON), delete e.useGeoJSON, e = t({map: this.map}, e), 0 == r && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = n(o(e.paths, s, r)));
    ...
    return l.prototype.getRoutes = function (e) {
        ...
        var o = {avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: []}, n = t(o, e);
        ...
        var r = this, s = new google.maps.DirectionsService;
        ...
        if (e.origin && e.destination) this.getRoutes({
            ...
            callback: function (t) {
                if (t.length > 0 && e.start && e.start(t[t.length - 1]), t.length > 0 && e.step) {
                    var o = t[t.length - 1];
                    if (o.legs.length > 0)for (var n, r = o.legs[0].steps, s = 0; n = r[s]; s++)n.step_number = s, e.step(n, o.legs[0].steps.length - 1)
                }
        ...
        if (e.origin && e.destination) this.getRoutes({
            ...
            callback: function (o) {
                if (o.length > 0 && e.start && e.start(o[o.length - 1]), o.length > 0 && e.step) {
                    var n = o[o.length - 1];
                    if (n.legs.length > 0)for (var r, s = n.legs[0].steps, i = 0; r = s[i]; i++)r.step_number = i, t.drawPolyline({
                        path: r.path,
                        strokeColor: e.strokeColor,
                        strokeOpacity: e.strokeOpacity,
                        strokeWeight: e.strokeWeight
        ...
        }); else if (e.route && e.route.legs.length > 0)for (var o, n = e.route.legs[0].steps, r = 0; o = n[r]; r++)o.step_number = r, t.drawPolyline({
            path: o.path,
            strokeColor: e.strokeColor,
            strokeOpacity: e.strokeOpacity,
            strokeWeight: e.strokeWeight
        ...
        var o, n = [], r = "http://maps.googleapis.com/maps/api/staticmap";
        ...
        if (i)for (var d = 0; d < i.length; d++) {
            ...
            for (var m = 0; m < i[d].stylers.length; m++)for (var y in i[d].stylers[m]) {
        ...
        if (a) {
            ...
            var b = o.path;
            if (b.join)for (var _, m = 0; _ = b[m]; m++)a.push(_.join(",")); else a.push("enc:" + b);
        ...
        for (var n = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], r = t({visible: !0}, e), s = 0; s < n.length; s++)delete r[n[s]];
        ...
        if (-1 == l.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2)); else if (e in o.registered_events)for (var n = o.registered_events[e], r = 0; r < n.length; r++)!function (e, t, o) {
            e.apply(t, [o])
        }(n[r].handler, o, t)
        ...
        for (var o = !1, n = this.getPaths().getLength(), r = 0; n > r; r++)for (var s = this.getPaths().getAt(r), i = s.getLength(), a = i - 1, l = 0; i > l; l++) {
            var p = s.getAt(l), g = s.getAt(a);
