@extends('frontend.layout.layout-subheader')
...
@section('content')
    ...
    <section class="module no-padding properties featured">
        ...
        <div class="container">
            <div class="module-header">
                ...
                <img src="{{$base_url_frontend}}/images/divider.png" alt=""/>
                <p>Morbi accumsan ipsum velit nam nec tellus a odiose tincidunt auctor a ornare odio sed non mauris vitae
                    erat consequat auctor</p>
            </div>
        </div>
            ...
            <div class="slider slider-featured">
                ...
                <div class="property property-hidden-content slide">
                    ...
                    <a href="#" class="property-img">
                        ...
                        <img src="{{$base_url_frontend}}/images/property-img1.jpg" alt=""/>
                    </a>
                </div>
                ...
                <div class="property property-hidden-content slide">
                    ...
                    <a href="#" class="property-img">
                        ...
                        <div class="property-price">$150,000</div>
                        <div class="property-color-bar"></div>
                        <img src="{{$base_url_frontend}}/images/property-img2.jpg" alt=""/>
                    </a>
                </div>
                ...
                <div class="property property-hidden-content slide">
                    ...
                    <a href="#" class="property-img">
                        ...
                        <div class="property-price">$150,000</div>
                        <div class="property-color-bar"></div>
                        <img src="{{$base_url_frontend}}/images/property-img3.jpg" alt=""/>
                    </a>
                </div>
                ...
                <div class="property property-hidden-content slide">
                    ...
                    <a href="#" class="property-img">
                        ...
                        <div class="property-price">$150,000</div>
                        <div class="property-color-bar"></div>
                        <img src="{{$base_url_frontend}}/images/property-img4.jpg" alt=""/>
                    </a>
                </div>
    ...
    <section class="module testimonials">
        ...
        <div class="container">
            <div class="module-header">
                ...
                <img src="{{$base_url_frontend}}/images/divider-white.png" alt=""/>
                <p>Morbi accumsan ipsum velit nam nec tellus a odiose tincidunt auctor a ornare odio sed non mauris vitae
                    erat consequat auctor</p>
            </div>
        </div>
        ...
        <div class="container">
            <div class="slider slider-testimonials">
                <div class="testimonial slide">
                    <h3>"Homely helped us sell our house with minimal effort. Their team was efficient and always there to
                        help!"</h3>
                    <div class="testimonial-details">
                        <img class="testimonial-img" src="{{$base_url_frontend}}/images/testimonial-img.png" alt=""/>
                ...
                <div class="testimonial slide">
                    <h3>"Homely helped us sell our house with minimal effort. Their team was efficient and always there to
                        help! Homely helped us sell our house with minimal effort. Their team was efficient and always there
                        to help!"</h3>
                    <div class="testimonial-details">
                        <img class="testimonial-img" src="{{$base_url_frontend}}/images/testimonial-img.png" alt=""/>
                        <p class="testimonial-name"><strong>John Doe</strong></p>
    ...
    <section class="module properties">
        <div class="container">
                    ...
                    <div class="property shadow-hover">
                        ...
                        <div class="property-content">
                            <div class="property-title">
                                ...
                                <p class="property-address"><i class="fa fa-map-marker icon"></i>123 Smith Dr, Annapolis, MD
                                </p>
                            </div>
                            <table class="property-details">
                                <tr>
            ...
            <div class="center"><a href="#" class="button button-icon more-properties-btn"><i class="fa fa-angle-right"></i>
                    View More Properties</a></div>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="agent shadow-hover">
                        <a href="#" class="agent-img">
                            ...
                            <img src="{{$base_url_frontend}}/images/agent-img1.jpg" alt=""/>
                        </a>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="agent shadow-hover">
                        <a href="#" class="agent-img">
                            ...
                            <img src="{{$base_url_frontend}}/images/agent-img2.jpg" alt=""/>
                        </a>
                        <div class="agent-content">
                            <div class="agent-details">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="agent shadow-hover">
                        <a href="#" class="agent-img">
                            ...
                            <img src="{{$base_url_frontend}}/images/agent-img4.jpg" alt=""/>
                        </a>
                        <div class="agent-content">
                            <div class="agent-details">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="agent shadow-hover">
                        <a href="#" class="agent-img">
                            <div class="img-fade"></div>
                            <div class="button alt agent-tag">24 Properties</div>
                            <img src="{{$base_url_frontend}}/images/agent-img3.jpg" alt=""/>
                        </a>
                        <div class="agent-content">
                            <div class="agent-details">
...
@section('script')
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAFst-kB60jSfNMoanSrRdqACr50mI37Ts&sensor=false"></script>
    <script src="{{ $base_url_frontend }}/js/map.js"></script> <!-- google maps -->
@endsection