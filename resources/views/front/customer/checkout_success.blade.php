...
@section('css')
    @parent
    <meta http-equiv="{{url('/change-password-success')}}" content="10">
@endsection
    ...
    <div class="main-container col2-right-layout">
        <div class="main container">
            <div class="row">                <div id="content" class="col-sm-12">
                    <div class="col-main">
                        <h1>{{_t('Your order has been placed!')}}</h1>
                        <p>{{_t('Your order has been successfully processed!')}}</p><p>{{_t('You can view your order history by going to the')}} <a href="{{url('/my-account')}}" style="font-size: 16px; color: rgba(22,16,221,0.77) !important;">{{_t('my account')}}</a> {{_t('page and by clicking on')}} <a href="{{url('/order/history').'/'.Auth::id()}}" style="font-size: 16px; color: rgba(22,16,221,0.77) !important;">{{_t('history')}}</a>.</p><p>{{_t('Please direct any questions you have to the')}} <a href="{{url('/user/contact')}}" style="font-size: 16px; color: rgba(22,16,221,0.77) !important;">{{_t('store owner')}}</a>.</p><p>{{_t('Thanks for shopping with us online!')}}</p><div class="buttons">
                            <div class="pull-right">
                                <a href="{{url('/')}}" type="button" class="button continue"> {{_t('Continue')}} </a>
                            </div>
                        </div>
                    </div></div>
            </div>
