        ...
        <div class="main container">
            <div class="row">                <div id="content" class="col-sm-12">
                    <div class="col-main">
                        ...
                        <p>Your order has been successfully processed!</p><p>You can view your order history by going to the <a href="{{url('/my-account').'/'.Auth::id()}}">my account</a> page and by clicking on <a href="{{url('/order/history').'/'.Auth::id()}}">history</a>.</p><p>If your purchase has an associated download, you can go to the account <a href="http://linea.magikthemes.com/index.php?route=account/download">downloads</a> page to view them.</p><p>Please direct any questions you have to the <a href="http://linea.magikthemes.com/index.php?route=information/contact">store owner</a>.</p><p>Thanks for shopping with us online!</p>      <div class="buttons">
                            <div class="pull-right">
                                <!-- <a href="" class="btn btn-primary"></a> -->
                                <button onclick="window.location='{{url('/')}}';" type="submit" class="button continue"> Continue </button>
                            </div>
                        </div>
                    </div></div>
            </div>
