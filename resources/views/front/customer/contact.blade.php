        ...
        <div class="main container">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li> <span>/</span>                            <strong>{{_t('Contact Us')}}</strong>            </li>
                </ul>
            </div>
            <div class="row">                <div id="content" class="col-sm-12">
                    <div class="col-main">
                        <div class="my-account">
                            ...
                            <h3>{{_t('Our Location')}}</h3>
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-3"><strong>{{_t('Our Store')}}</strong><br>
                                            <address>{{ \App\Models\Backend\WebSetting::getSetting('address')}}</address>
                                        </div>
                                        <div class="col-sm-3"><strong>{{_t('Telephone')}}</strong><br>
                                            {{ \App\Models\Backend\WebSetting::getSetting('phone')}}<br>
                                            <br>
                                        </div>
                                        <div class="col-sm-3">
                                        </div>
                            ...
                            <form action="{{url('/post-contact')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                {{ csrf_field() }}
                                <fieldset>
                                    <legend>Contact Form</legend>
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label" for="input-name">{{_t('Your Name')}}</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="username" value="" id="input-name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label" for="input-email">{{_t('E-Mail Address')}}</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="email" value="" id="input-email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label" for="input-enquiry">{{_t('Enquiry')}}</label>
                                        <div class="col-sm-10">
