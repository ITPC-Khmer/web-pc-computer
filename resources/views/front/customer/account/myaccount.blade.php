                    ...
                    <div class="col-main">
                        <div class="my-account">
                            ...
                            <ul class="list-unstyled">
                                @if (Auth::guest())
                                @else
                                    <li><a href="{{url('/edit-account')}}">{{_t('Edit your account information')}}</a></li>
                                    <li><a href="{{url('/reset-password')}}">{{_t('Change your password')}}</a></li>
                                    <li><a href="{{url('/address')}}">{{_t('Modify your address book entries')}}</a></li>
                                    <li><a href="{{url('/wish-list')}}">{{_t('Modify your wish list')}}</a></li>
                                @endif
                            </ul>
                            <h2>{{_t('My Orders')}}</h2>
                            <ul class="list-unstyled">
                                @if (Auth::guest())
                                @else
                                <li><a href="{{url('/order/history').'/'.Auth::id()}}">{{_t('View your order history')}}</a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
