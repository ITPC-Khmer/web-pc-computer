            ...
            <div class="row">                <div id="content" class="col-sm-9">
                    <div class="col-main">
                        <div class="my-account">
                            ...
                            @endif
                            <form action="{{url('/edit-account')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                {{ csrf_field() }}
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" value="{{$user->name}}" placeholder="First Name" id="input-firstname" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                ...
                                <div class="buttons clearfix">
                                    <div class="pull-left">
                                        <a href="{{url('/my-account')}}" class="btn btn-default">Back</a></div>
