                        ...
                        <div class="my-account">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <tbody><tr>
                                        <td class="text-left">{{$user->house_number}}<br>{{$user->road}}<br>{{$user->sangkat}}<br>{{$user->khan}}<br>{{$user->province_city}}</td>
                                    </tr>
                                    </tbody></table>
                            </div>
                            <div class="buttons clearfix">
                                <div class="pull-left">
                                    <a href="{{url('/')}}" class="btn btn-default">Back</a></div>
                                <div class="pull-right">
                                    <!-- <a href="" class="btn btn-primary"></a> -->
                                    <a href="{{url('/edit-address').'/'.Auth::id()}}" type="button" class="button continue">Edit Address</a>
                                </div>
                            </div>
                        </div>
                    </div>
