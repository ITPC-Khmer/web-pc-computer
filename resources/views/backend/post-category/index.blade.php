...
@section('title',_t('Post Category'))
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-bell-o"></i>{{ _t('Post Category') }} </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable table-responsive">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tr>
                                <th style="width: 160px;">  <a href="{{ url('/backend/post-category-form') }}" class="btn btn-outline btn-circle btn-sm purple">
                            ...
                            @foreach ($result as $row)
                                <tr>
                                    <td>
                                        {!! Form::open(['url' => "/backend/post-category-form", 'method' => 'put']) !!}
                                        ...
                                        <a data-href="{{ url('/backend/post-category-delete') }}" data-id="{{  $row->id }}" href="javascript:" class="btn btn-outline btn-circle dark btn-sm black vm-del">
                                    ...
                                    <td class="hidden-xs"> {!! highlight($row->hierarchical_title,$title) !!} </td>
                                    ...
                                    <td class="hidden-xs">
                                        ...
                                        'data-url'=> url("/backend/post-category-update-status")]) !!}
                                    </td>
