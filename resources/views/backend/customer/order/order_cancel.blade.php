...
@section('title',_t('Order Cancel Page'))
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-bell-o"></i>{{ _t('Order Cancel List') }} </div>
                    <div class="tools">
                                    ...
                                    <td>
                                        ...
                                        @if($row->cancel-0==1)
                                            <a data-id="" href="javascript:;"
                                               class="btn btn-icon-only purple btn-uncancel-option" data-idc="{{$row->id}}">
