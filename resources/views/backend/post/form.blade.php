@php
    ...
    $category_id = \App\Models\Backend\Post::getArrPostCategoryDetailId($id);
    $tag_id = \App\Models\Backend\Post::getArrPostTagDetailId($id);
@endphp
...
@section('content')
    @component('component.form',['option' => ['url' => '/backend/post-save','id'=>'fileupload'],'title' => _t('Post Form')])
        {!! Form::hidden('id',$id) !!}
        ...
        <div class="form-body">
            ...
            <div class="row">
                ...
                <select required="required"  name="category_id[]"
                        class="category_id form-control" multiple="multiple">
                    <option value="0"></option>
                    {!! \App\Models\Backend\Post::getOpCategory($category_id) !!}
                </select>
                @endcomponent

                @component('component.input', ['label' => _t('Tag'),'sms' => ''])
                <select  name="tag_id[]"
                        class="tag_id form-control" multiple="multiple">
                    <option value="0"></option>
                    {!! \App\Models\Backend\Post::getOpTag($tag_id) !!}
                </select>
                @endcomponent
