    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 margin-bottom-10">
            <div class="dashboard-stat blue">
                ...
                <div class="details">
                    ...
                    <div class="desc"> Lifetime Salesfgfdgsd </div>
                </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="dashboard-stat red">
                ...
                <div class="details">
                    <div class="number"></div>
                    <div class="desc"> Total Orders fgsdzg</div>
                </div>
                <a class="more" href="#"> View more
                    <i class="m-icon-swapright m-icon-white"></i>
                </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number"> </div>
                    <div class="desc"> Average Ordersfgsdgsdg </div>
                </div>
                <a class="more" href="#"> View more
                    <i class="m-icon-swapright m-icon-white"></i>
                </a>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-bell-o"></i>{{ _t('Post') }} </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable table-responsive">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            ...
                            <tr>
                                <th style="width: 98px;">  <a href="{{ url('/backend/post-form') }}" class="btn btn-icon-only green">
                            ...
                            @foreach ($result as $row)
                                <tr>
                                    <td>
                                        {!! Form::open(['url' => "/backend/post-form", 'method' => 'put']) !!}
                                        {!! Form::hidden('id',$row->id) !!}
                                        {!! Form::hidden('_page',$page) !!}

                                        <button type="submit" class="btn btn-icon-only purple">
                                            <i class="fa fa-edit"></i></button>
                                        <a data-href="{{ url('/backend/post-delete') }}" data-id="{{  $row->id }}" href="javascript:" class="btn btn-icon-only red vm-del">
                                    ...
                                    <td class="hidden-xs">
                                        ...
                                        'data-url'=> url("/backend/post-update-status")]) !!}
                                    </td>
