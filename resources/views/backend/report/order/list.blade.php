...
<div id="report-print">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px; margin-top: 10px;">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align: center;">
            ...
            <span style="font-size: 18px;"><b>{{_t('SALE ORDER LIST')}}</b></span>
        </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <table class="table table-bordered" style="width: 100%;">
            ...
            <tr style="font-size: 14px;">
                ...
                <th class="text-center">{{_t('Sub Tot')}}al</th>
            ...
            @endphp
                ...
                @foreach($rows as $row)
                    ...
                    <tr style="font-size: 12px;">
                        ...
                        <td class="text-center">  @if(($row->paid) != 1 && ($row->cancel) != 1 ) <b style="color: red;">{{_t('Pending')}}</b> @endif @if(($row->paid) != 0) <b style="color: green;">{{_t('Paid')}}</b> @endif @if(($row->cancel) != 0 ) <b style="color: #ff7813;">{{_t('Cancel')}}</b> @endif</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
