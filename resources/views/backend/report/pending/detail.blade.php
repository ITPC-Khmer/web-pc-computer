...
<div id="report-print">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px; margin-top: 10px;">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align: center;">
            ...
            <span style="font-size: 18px;"><b>{{_t('PENDING ORDER DETAIL')}}</b></span>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
        </div>
    </div>
    @foreach($rows as $row)
        @if(($row->paid) != 1 && ($row->cancel) != 1 )
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border: solid 1px darkgrey; margin-bottom: 10px;">
            <div style="font-size:14px;">
                <table style="width: 100%; margin-bottom: 10px; margin-top: 10px;">
                    ...
                    <tr style="text-align:center;">
                        <td style="vertical-align:middle;text-align:left; padding-left:10px;"><span><b>{{_t('Sale Process')}}</b></span> : @if(($row->paid) != 1 && ($row->cancel) != 1 ) <b style="color: #68ff1e;">{{_t('Pending')}}</b> @endif</td>
                    </tr>
                    </tbody>
                </table>
            </div>
