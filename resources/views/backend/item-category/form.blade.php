...
@section('title',_t('Item Category Form'))

@section('content')
    @component('component.form',['option' => ['url' => '/backend/item-category-save','id'=>'fileupload'],'title' => _t('Item Category Form')])
        {!! Form::hidden('id',$id) !!}
            ...
            <div class="row">
               ...
               {{-- {!! Form::select('parent',$opc,$parent,['class'=>"form-control", 'placeholder'=>"Parent here.."]) !!}--}}
                    <select name="parent" class="form-control">
                        ...
                        {!! \App\Models\Backend\ItemCategory::getParent($id,$parent) !!}
                    </select>
                @endcomponent
