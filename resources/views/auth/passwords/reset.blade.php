        ...
        <div class="main container">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li><span>/</span>
                        <a href="{{url('/account')}}">{{_t('Account')}}t</a>
                    </li>
                    <li><span>/</span>
                        <strong>{{_t('Change Password')}}</strong>
                    </li>
                </ul>
            </div>
            <div class="row">
                            ...
                            <form action="{{ url('/change-password') }}" method="POST" class="form-horizontal">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group{{ $errors->has('old_password') ? ' has-error' : '' }} required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="password" name="old_password" placeholder="Old Password" id="password" class="form-control" required>
                                    ...
                                    <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }} required">
                                        <label class="col-sm-2 control-label" for="input-confirm">Confirm New Password</label>
                                        <div class="col-sm-10">
                                            <input type="password" name="password_confirmation" value="" placeholder="Confirm New Password" id="password-confirm" class="form-control">
                                ...
                                <div class="buttons clearfix">
                                    <div class="pull-left"><a href="{{url('/my-account')}}" class="btn btn-default">Back</a></div>
