...
<div class="logo">
    <a href="index.html">
        ...
        {{--<img src="{{ $base_url }}assets/pages/img/logo-bigMS.png" alt="" /> </a>--}}
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
...
<!-- END LOGIN -->
<!-- BEGIN COPYRIGHT -->
<div class="copyright">Copyright ©2017 KST COL.,TD (Cambodia). All rights reserved. </div>
<div class="copyright"><a href="{{url('/')}}"><b>Back to Website</b></a></div>
<!-- END COPYRIGHT -->
<!--[if lt IE 9]>
